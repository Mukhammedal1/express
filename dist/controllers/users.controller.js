...
const addUser = async (req, res) => {
    try {
        ...
        await mailService.sendMailActivationCode(value.email, `${process.env.API_URL}/api/users/activate/${activation_link}`);
...
export { addUser, findAllUsers, findUserById, updateUserById, deleteUserById, activateUser, loginUser, };
